...
vector2d_t draw_combat_view_image(vector2d_t anchor, const character_t* player, const character_t* enemy, const char* image_path, bool red_enemy);
 ...
 */
vector2d_t draw_combat_view_animated(vector2d_t anchor, const character_t* player, const character_t* enemy, const char* image_path, bool red_enemy);
