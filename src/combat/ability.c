...
ability_table_t* init_ability_table(void) {
    ...
    init_ability(&table->abilities[FIREBALL],"Fireball", 4, 10, D10, MAGICAL);
    init_ability(&table->abilities[SWORD_SLASH],"Sword Slash", 4, 10, D6, PHYSICAL);
    init_ability(&table->abilities[BITE],"Bite", 3, 20, D8, PHYSICAL);
    return table;
}
